...
Wild include a flake, a derivation for buiding Wild, and a stdenv adapter
in-tree. If overlayed these are provided for you. Just add it to your flake
inputs. A devShell example is also shown with the flake.
