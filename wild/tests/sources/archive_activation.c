...
// will be GCed when we link. However its presence, or rather the reference
// that it contains to the function `bar` causes the archive member containing
// `bar` to be activated, which causes an alternate version of
