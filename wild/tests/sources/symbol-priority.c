...
// shared objects. We have a direct reference to the symbol, so will need a
// copy relocation. Having data and functions with the same name isn't
// something we'd expect to see, however it's a useful way to verify that we're
// selecting the symbol from expected shared object.
extern int v2[];
