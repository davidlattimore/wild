...
// An int that has 64-byte alignment. Notably, the size here is smaller than the alignment. This is
// to verify that we correctly handle the alignment when performing a copy relocation.
