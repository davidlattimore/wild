...
// Call from a default-aligned function to a 32-byte aligned function then back to a default aligned
// function.
...
// ifunc2 differs from ifunc1 in that it (the resolver function) is defined here, which is a long
// way from the PLT that calls will go via.
