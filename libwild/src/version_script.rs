...
mod tests {
    ...
    fn test_escape_sequences() {
        ...
        let exact_patterns: HashSet<&str> = version_body
            .globals
            .general
            .exact
            .iter()
        ...
        assert!(exact_patterns.contains(r"foo\*bar"));
        assert!(exact_patterns.contains(r"baz\?"));
        assert!(exact_patterns.contains(r"foo1\\foo2"));
