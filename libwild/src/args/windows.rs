...
pub(crate) fn setup_windows_argument_parser() -> ArgumentParser<PeArgs> {
    ...
    parser
        ...
        .sub_option("UPONLY", "Runs only on a uniprocessor system.", |_, _| {
            unimplemented_option("/DRIVER:UPONLY")
        })
        .sub_option("WDM", "Creates a Windows Driver Model driver.", |_, _| {
            unimplemented_option("/DRIVER:WDM")
        })
    ...
    parser
        ...
        .sub_option("NOREF", "Keep unreferenced functions and data.", |_, _| {
            unimplemented_option("/OPT:NOREF")
        })
...
mod tests {
    ...
    const WINDOWS_LINKER_ARGS: [&str; 28] = [
    ...
    fn test_parse_windows_linker_args() {
        let args =
            unwrap_pe(crate::args::Args::parse(|| WINDOWS_LINKER_ARGS.into_iter()).unwrap());
    ...
    fn test_minimal_windows_args() {
        ...
        let args = unwrap_pe(crate::args::Args::parse(|| minimal_args.into_iter()).unwrap());
    ...
    fn test_debug_flag_simple() {
        ...
        let result = crate::args::Args::parse(|| minimal_args.into_iter());
        match result {
            Ok(args) => {
    ...
    fn test_required_parameters() {
        ...
        let result = crate::args::Args::parse(|| implib_args.into_iter());
        match result {
        ...
        let result = crate::args::Args::parse(|| export_args.into_iter());
        match result {
        ...
        let result = crate::args::Args::parse(|| version_args.into_iter());
        match result {
    ...
    fn test_unimplemented_options() {
        ...
        let result = crate::args::Args::parse(|| appcontainer_args.into_iter());
        match result {
        ...
        let result = crate::args::Args::parse(|| assemblydebug_args.into_iter());
        match result {
    ...
    fn test_case_insensitive_parsing() {
        ...
        let result_upper = unwrap_pe(crate::args::Args::parse(|| args_upper.into_iter()).unwrap());
        ...
        let result_lower = unwrap_pe(crate::args::Args::parse(|| args_lower.into_iter()).unwrap());
        ...
        let result_mixed = unwrap_pe(crate::args::Args::parse(|| args_mixed.into_iter()).unwrap());
    ...
    fn test_nodefaultlib_parsing() {
        ...
        let result_all = unwrap_pe(crate::args::Args::parse(|| args_all.into_iter()).unwrap());
        ...
        let result_specific = unwrap_pe(crate::args::Args::parse(|| args_specific.into_iter()).unwrap());
        ...
        let result_multiple = unwrap_pe(crate::args::Args::parse(|| args_multiple.into_iter()).unwrap());
        ...
        let result_case_insensitive =
            unwrap_pe(crate::args::Args::parse(|| args_case_insensitive.into_iter()).unwrap());
