...
pub(crate) const SYMTAB_SHNDX: PartId = PartId(29);
// Mach-O specific sections
pub(crate) const PAGEZERO_SEGMENT: PartId = PartId(30);
pub(crate) const TEXT_SEGMENT: PartId = PartId(31);
pub(crate) const DATA_SEGMENT: PartId = PartId(32);
