...
pub(crate) const SYSV_HASH: PartId = PartId(11);
pub(crate) const GNU_HASH: PartId = PartId(12);
pub(crate) const DYNSYM: PartId = PartId(13);
pub(crate) const DYNSTR: PartId = PartId(14);
pub(crate) const INTERP: PartId = PartId(15);
pub(crate) const GNU_VERSION: PartId = PartId(16);
pub(crate) const GNU_VERSION_D: PartId = PartId(17);
pub(crate) const GNU_VERSION_R: PartId = PartId(18);
pub(crate) const NOTE_GNU_PROPERTY: PartId = PartId(19);
pub(crate) const NOTE_GNU_BUILD_ID: PartId = PartId(20);
pub(crate) const SYMTAB_LOCAL: PartId = PartId(21);
pub(crate) const SYMTAB_GLOBAL: PartId = PartId(22);
pub(crate) const RELA_DYN_RELATIVE: PartId = PartId(23);
pub(crate) const RELA_DYN_GENERAL: PartId = PartId(24);
pub(crate) const RISCV_ATTRIBUTES: PartId = PartId(25);
