...
impl<'data> crate::platform::ElfPlatform<'data> for ElfX86_64 {
    ...
    fn local_symbols_in_debug_info() -> bool {
        ...
        fn tp_offset_start(layout: &crate::layout::Layout<'data, crate::elf_layout::ElfLayout<'data>>) -> u64 {
...
fn test_relaxation() {
    ...
    use crate::platform::ElfPlatform as _;
